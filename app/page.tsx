  ...
  return (
    <div ref={containerRef} className="relative h-screen w-full overflow-hidden">
      ...
      <header className="container mx-auto absolute top-0 left-0 right-0 z-50 px-8 py-6">
        <div className="max-w-8xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="md:text-xl text-md font-bold text-white">Pizza Pantry</h1>
            </div>
          </div>
          <Link href="/sign-in" className="inline-block md:px-8 px-4 py-1 text-white border-2 border-white/50 rounded-full hover:bg-white hover:text-gray-900 transition-all duration-300 backdrop-blur-sm"
      ...
      <div className="container mx-auto relative h-full flex items-center">
        <div className="px-8 w-full md:mt-0">
          <div className="grid lg:grid-cols-2 justify-between items-center">
            ...
            <div className="relative lg:mt-0 mt-12">
              ...
              <div className="max-w-xl float-end">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                  <p className="md:text-6xl text-4xl font-bold text-white mb-2">
          ...
          <div className='flex justify-between md:flex-row flex-col md:mt-12 mt-6'>
            <div className="flex items-center lg:justify-end justify-center gap-6 z-50">
            ...
            <div className="w-full md:my-0 my-6 flex items-center lg:justify-end justify-center gap-6 z-50">
      ...
      <footer className="absolute bottom-0 left-0 right-0 z-40 bbg-white/10 backdrop-blur-md border-t border-white">
        <div className="container mx-auto px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <span className="text-white/60 text-sm">Created by Vinolia Masango</span>
            </div>
          </div>
        </div>
      </footer>
